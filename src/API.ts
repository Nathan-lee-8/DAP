...
export type ModelUserGroupConditionInput = {
  ...
  groupMembersId?: ModelIDInput | null,
  owner?: ModelStringInput | null,
};
...
export type ModelSubscriptionGroupFilterInput = {
  ...
  groupMembersId?: ModelSubscriptionIDInput | null,
  owner?: ModelStringInput | null,
};
...
export type PostsByCommentCountQueryVariables = {
  createdAt: string,
...
export type PostsByCommentCountQuery = {
  postsByCommentCount?:  {
    __typename: "ModelPostConnection",
    items:  Array< {
      __typename: "Post",
